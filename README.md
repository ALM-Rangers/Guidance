...
|---------|-------|------|-------------------|
| Options for planning a TFS and AzDO engineering environment | Willy |[DRAFT](/src/Planning/understand-options-azure-devops-environments.md)| 
| Options for planning a TFS and AzDO engineering environment (workbook) | KenM | [DRAFT](/src/Planning/understand-options-azure-devops-environments-capacity-guide.xlsx) |  |  |
