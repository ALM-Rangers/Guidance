...
|---------|-------|------|-------------------|
| Options for planning a TFS and AzDO engineering environment | Willy |[DRAFT](/src/Planning/understand-options-tfs-vsts-environments.md)| 
| Options for planning a TFS and AzDO engineering environment (workbook) | KenM | [DRAFT](/src/Planning/understand-options-tfs-vsts-environments-capacity-guide.xlsx) |  |  |
